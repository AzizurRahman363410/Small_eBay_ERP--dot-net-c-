...
namespace Demo_1
{
    public partial class SalesList : Form
    {
        ...
        private void load()
        {
            ...
            OleDbDataAdapter da = new OleDbDataAdapter("SELECT * FROM SaleCustomer", conn);
            DataSet ds = new DataSet();
            conn.Open();
            da.Fill(ds, "SaleCustomer");
            dataGridView1.DataSource = ds.Tables["SaleCustomer"];
            conn.Close();
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "Delete From SaleCustomer Where [Id]=@id";
